      ...
      <div className="w-full max-w-5xl z-10 flex flex-col items-center gap-12">
        ...
        <div className="text-center space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="inline-flex items-center rounded-full border border-primary/20 bg-primary/5 px-3 py-1 text-sm font-medium text-primary backdrop-blur-sm">
            ...
            <span className="flex items-center gap-1">下一代账号资产管理系统 <span className="inline-block w-1.5 h-1.5 rounded-full bg-primary ml-1 animate-pulse"></span></span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70 pb-2">
            安全、高效的资源分发中心
          </h1>
          ...
          <CardContent className="pt-6">
            <Tabs defaultValue="user" className="w-full">
              <TabsList className="grid w-full grid-cols-2 h-12 bg-muted/50 p-1 rounded-xl backdrop-blur-sm mb-8">
                <TabsTrigger value="user" className="rounded-lg text-sm font-medium transition-all data-[state=active]:bg-background data-[state=active]:text-primary data-[state=active]:shadow-sm">用户通道</TabsTrigger>
                <TabsTrigger value="admin" className="rounded-lg text-sm font-medium transition-all data-[state=active]:bg-background data-[state=active]:text-primary data-[state=active]:shadow-sm">管理员入口</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="user" className="mt-0 focus-visible:outline-none">
                <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-300">
                  ...
                  <Button 
                    className="w-full h-12 text-base font-medium bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white shadow-lg shadow-blue-500/25 border-0 rounded-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]" 
              ...
              <TabsContent value="admin" className="mt-0 focus-visible:outline-none">
                <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-left-4 duration-300">
                  ...
                  <Button 
                    className="w-full h-12 text-base font-medium bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-500 hover:to-red-500 text-white shadow-lg shadow-orange-500/25 border-0 rounded-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl px-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
          {[
            { icon: Shield, title: "安全可靠", desc: "端对端加密传输，保障数据隐私安全" },
            { icon: Sparkles, title: "极速响应", desc: "毫秒级接口响应，流畅的交互体验" },
            { icon: Layers, title: "多维管理", desc: "灵活的分类与标签系统，高效资产归类" }
          ].map((item, i) => (
